...
await conn.sendNyanCat(m.chat, `‣ ${pickRandom(global.work)} *${hasil} XP*`, imgwork, '🍀❥៚⍣𝘾𝙍𝙄𝙒𝙄𝙇𝙊𝙋_𝘽𝙊𝙏࿐⛦🍀', `Wᴏʀᴋ ʙʏ 🍀❥⍣ᴄʀɪᴡɪʟᴏᴘ࿐⛦☘️👷🏻`, script, m)
...
"Ayudas a moderar el grupo de 🍀❥⍣ᴄʀɪᴡɪʟᴏᴘ࿐⛦☘️ por", "Diseñaste un logo para *🍀❥⍣ᴄʀɪᴡɪʟᴏᴘ࿐⛦☘️* por", 
"Moderaste el grupo cuando *🍀❥⍣ᴄʀɪᴡɪʟᴏᴘ࿐⛦☘️* no estaba, el pago fue", 
